...
export default function DetailPage({ params }: { params: { id: string } }) {
    ...
    useEffect(() => {
        // Decode ID if needed, though usually string is fine.
        // The original code handled '-dup' suffix logic in the component, so we keep it.
                    ...
                    <div className="container mx-auto px-4">
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-2">
                            <nav className="text-xs md:text-sm text-gray-400 flex items-center overflow-x-auto whitespace-nowrap">
                                <span onClick={() => router.push('/')} className="cursor-pointer hover:text-white transition-colors">Início</span>
                                <Icon name="ChevronRight" size={14} className="mx-2 shrink-0" />
                                <span onClick={() => router.push(`/listing?category=${ad.category}`)} className="cursor-pointer hover:text-white transition-colors capitalize">{ad.category}</span>
                                <Icon name="ChevronRight" size={14} className="mx-2 shrink-0" />
            ...
            <div className="bg-gray-100 min-h-screen pb-24 md:pb-12 font-sans">
                ...
                <div className="container mx-auto px-4 pt-4 md:pt-6 max-w-7xl">
                    ...
                    <nav className="text-sm text-gray-500 mb-4 flex items-center overflow-x-auto whitespace-nowrap pb-2">
                        <span onClick={() => router.push('/')} className="cursor-pointer hover:text-brand-red transition-colors">Início</span>
                        <Icon name="ChevronRight" size={14} className="mx-2 shrink-0" />
                        <span onClick={() => router.push(`/listing?category=adultos`)} className="cursor-pointer hover:text-brand-red transition-colors">Acompanhantes</span>
                        <Icon name="ChevronRight" size={14} className="mx-2 shrink-0" />
        ...
        <div className="bg-gray-50 min-h-screen pb-24 md:pb-12">
            ...
            <div className="container mx-auto px-4 py-6">
                <nav className="text-sm text-gray-500 mb-6 flex items-center overflow-x-auto whitespace-nowrap pb-2">
                    <span onClick={() => router.push('/')} className="cursor-pointer hover:text-brand-red">Início</span>
                    <Icon name="ChevronRight" size={14} className="mx-2 shrink-0" />
                    <span onClick={() => router.push(`/listing?state=${ad.state}`)} className="cursor-pointer hover:text-brand-red capitalize">{ad.state}</span>
                    <Icon name="ChevronRight" size={14} className="mx-2 shrink-0" />
                    <span onClick={() => router.push(`/listing?category=${ad.category}`)} className="cursor-pointer hover:text-brand-red capitalize">{ad.category}</span>
                    <Icon name="ChevronRight" size={14} className="mx-2 shrink-0" />
                    <span className="font-medium text-gray-900 truncate">{ad.title}</span>
                </nav>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-8 space-y-6">
                        ...
                        {/* Additional content for standard layout can go here if needed */}
                    </div>
                </div>
            </div>
        </div>
